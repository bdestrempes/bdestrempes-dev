...
Most development teams start with simple `true`/`false` toggles, usually with the confident declaration "We'll keep it simple!" (they definitely did not keep it simple). Take this basic example from an e-commerce application:
